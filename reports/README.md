...
5. Get the preprocessed data and/or model weights with `dvc pull`
...
- /scripts: includes two bash scripts one is useful to run all the complete pipeline and another one that is used in the build dockerfile as entrypoint.
